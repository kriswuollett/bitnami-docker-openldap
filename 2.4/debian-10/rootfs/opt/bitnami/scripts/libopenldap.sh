...
export LDAP_ADMIN_PASSWORD_FILE="${LDAP_ENCRYPTED_ADMIN_PASSWORD:-}"
export LDAP_ENCRYPTED_ADMIN_PASSWORD="$(([[ -f "$LDAP_ADMIN_PASSWORD_FILE" ]] && cat "$LDAP_ADMIN_PASSWORD_FILE" || echo -n $LDAP_ADMIN_PASSWORD) | slappasswd -n -T /dev/stdin)"
...
export LDAP_CONFIG_ADMIN_PASSWORD_FILE="${LDAP_CONFIG_ADMIN_PASSWORD_FILE:-}"
export LDAP_ENCRYPTED_CONFIG_ADMIN_PASSWORD="$(([[ -f "$LDAP_CONFIG_ADMIN_PASSWORD_FILE" ]] && cat "$LDAP_CONFIG_ADMIN_PASSWORD_FILE" || echo -n $LDAP_CONFIG_ADMIN_PASSWORD) | slappasswd -n -T /dev/stdin)"
